<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmMain.aspx.cs" Inherits="FriendBook.frmMain" %>
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    <div class="w3-col l8 m6">
      <h1 class="w3-jumbo"><b>Friendbook</b></h1>
      <h1 class="w3-xxxlarge w3-text-green"><b>Where Your Social Life Begins...</b></h1>
      <p><span class="w3-xlarge">Meet new people!</span> <p>Find your friends and lovers that suit your choices!</p>
    ...
    <div class="w3-col l4 m6">
      <img src="Images/social.jpeg" class="w3-image w3-right w3-hide-small" width="335">
      <div class="w3-center w3-hide-large w3-hide-medium">
        <button class="w3-button w3-block w3-padding-large" onclick="document.getElementById('download').style.display='block'">
          <i class="fa fa-download"></i> Download Application</button>
